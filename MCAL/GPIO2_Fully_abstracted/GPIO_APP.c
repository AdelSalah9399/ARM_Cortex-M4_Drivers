...
{
		/*________Mode__________________*/
		GPIO_SetPinMode(PinCFG->_Port, PinCFG->_Pin, PinCFG->_Mode);
						/*^^_Output Type_^^*/
			if(PinCFG->_Mode == GPIO_MODE_OUTPUT)
			{
				GPIO_SetPinType(PinCFG->_Port, PinCFG->_Pin,PinCFG->_Type);
			}
						/*^^_Input_PULL/UP-DOWN_^^*/
			else if(PinCFG->_Mode == GPIO_MODE_INPUT)
			{
				GPIO_SetPullUpDownType(PinCFG->_Port, PinCFG->_Pin,PinCFG->_PUPD);
			}
		/*_______Speed_________________*/
		GPIO_SetPinSpeed(PinCFG->_Port, PinCFG->_Pin,PinCFG->_Speed);
		/*_______AF____________________*/
		GPIO_SetAlternativeFunction(PinCFG->_Port, PinCFG->_Pin,PinCFG->_AF);
}
